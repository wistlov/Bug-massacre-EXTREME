...
import random
import os
import time   #In the end, I didnt get to use this, becaused it caused these wierd glitches, but I will do it later!
...
player_x_pos = 0    #Self explanatory
player_y_pos = 0
enemy_speed = 2
enemy_nr = 0    #This is so I can keep track of how many enemies there are som they dont multiply into infinity
...
"""
Under, you can see the classes, which is something I had never used before,
but I am happy to say that I believe I have a pretty good grasp of it now.
The classes might be the biggest part of my game, and the one thing I had the most trouble with.
The classes makes me able to have multiple copies of the same sprites, without having to make a new sprite for every entity
"""
...
class Bug(pygame.sprite.Sprite):
    ...
    def update(self):
        """
        This under here is what remains of a big pain in the ass. Trying to make the enemies smart and behave better is impossible
        without making them go bersekr and spinning around like crazy! So to comemorate (is that how you spell it?) the time lost dealing with 
        bugs (litteraly), I left this tiny piece of code as a comment
...
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # If it moves of the screen, it gets ELIMINATED!
